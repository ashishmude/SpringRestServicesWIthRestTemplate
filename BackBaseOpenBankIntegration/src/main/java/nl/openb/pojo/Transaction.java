...
public class Transaction {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(id).append(thisAccount).append(otherAccount).append(details).append(metadata).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(id, rhs.id).append(thisAccount, rhs.thisAccount).append(otherAccount, rhs.otherAccount).append(details, rhs.details).append(metadata, rhs.metadata).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
